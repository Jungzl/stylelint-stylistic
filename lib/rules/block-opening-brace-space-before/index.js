...
const {
  beforeBlockString, blockString, hasBlock, hasEmptyBlock, optionsMatches, report, ruleMessages, validateOptions, whitespaceChecker, validateTypes: { isRegExp, isString },
} = utils
