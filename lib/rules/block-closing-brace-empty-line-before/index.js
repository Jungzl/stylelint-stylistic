...
const {
  addEmptyLineAfter, blockString, hasBlock, hasEmptyBlock, hasEmptyLine, isSingleLineString, optionsMatches, removeEmptyLinesAfter, report, ruleMessages, validateOptions,
} = utils
