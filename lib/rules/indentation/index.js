...
const {
  beforeBlockString, hasBlock, optionsMatches, report, ruleMessages, validateOptions,
  typeGuards: { isAtRule, isDeclaration, isRoot, isRule },
  validateTypes: { isBoolean, isNumber, isString, assertString },
} = utils
